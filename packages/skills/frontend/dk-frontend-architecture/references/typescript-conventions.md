...
Reglas de estilo y tipado a aplicar en todo código TypeScript del proyecto, independientemente de la capa (context, store, services, useCases, pages).
...
- Use named exports (`export const`) exclusively
